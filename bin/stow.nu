...
def create-stow-structure [
    ...
    if $source_type == 'dir' {
        ...
        # Read from source (following symlinks) and write to destination
...
export def main [
    ...
    # Set defaults
    let target_dir = if $target_dir == null { $env.HOME } else { $target_dir }
...
export def "main apply" [
    ...
    let backup_dir = if $backup_dir == null {
