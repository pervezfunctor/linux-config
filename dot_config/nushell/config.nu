...
alias ce = chezmoid edit
alias ca = chezmoid apply
alias cs = chezmoid status
alias cu = chezmoid update
alias cc = chezmoid cd
alias cw = ~/.local/share/chezmoi/scripts/chezmoi-sync & disown
alias cA = chezmoid add
alias cf = chezmoid forget
